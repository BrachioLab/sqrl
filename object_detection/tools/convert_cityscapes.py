...
parser.add_argument("--specified_img_dir", type=str, default=None, help="Output directory")
parser.add_argument("--specified_gt_dir", type=str, default=None, help="Output directory")
...
def main(args):
    ...
    # Process splits
    images = []
    if args.specified_img_dir is None or args.specified_gt_dir is None:
        ...
        split="val"
        print("Converting", split, "...")
        split_img_subdir, split_msk_subdir = args.specified_img_dir, args.specified_gt_dir
        img_base_dir = path.join(args.root_dir, split_img_subdir)
        msk_base_dir = path.join(args.root_dir, split_msk_subdir)
        img_list = _get_images(msk_base_dir)
