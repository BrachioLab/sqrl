...
class FinBert(object):
    ...
    def train(self, train_examples, model):
        ...
        # Training
        train_dataloader, _ = self.get_loader(train_examples, 'train')
    ...
    def evaluate(self, model, examples):
        ...
        eval_loader, texts = self.get_loader(examples, phase='eval')
        ...
        evaluation_df = pd.DataFrame({'tokens': texts, 'predictions': predictions, 'labels': labels, "agree_levels": agree_levels})
